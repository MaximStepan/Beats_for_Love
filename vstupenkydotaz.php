...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $den1 = isset($_POST['dayone']) ? "Ano" : "Ne";
    $den2 = isset($_POST['daytwo']) ? "Ano" : "Ne";
    $den3 = isset($_POST['daythree']) ? "Ano" : "Ne";
    $den4 = isset($_POST['dayfour']) ? "Ano" : "Ne";
    $vip = isset($_POST['vip']) ? "Ano" : "Ne";
    ...
    if ($conn->query($query) === TRUE) {
        ...
        $query_tickets = "INSERT INTO vstupenka (ID_uzivatel, VIP, Den_1, Den_2, Den_3, Den_4) 
                          VALUES ('$user_id', '$vip', '$den1', '$den2', '$den3', '$den4')";
...
<head>
    ...
    <title>Vstupenky festival</title>
    ...
    <style>
        ...
        .form-container input:focus {
            border-color: #d88a00; /* Změní barvu rámečku při zaměření */
            outline: none;
        }
        ...
        .form-container button:hover {
            background: #b77400; /* Změna barvy při najetí myší */
...
<body>
    ...
    <div class="form-container">
        <h2>Registrace pro předběžné zaslání vstupenek na festival Beats for Love</h2>
        <form action="#" method="post">
            ...
            <div class="checkbox-group">
                <div>
                    ...
                    <label for="dayone">Den 1</label>
                </div>
                <div>
                    <input type="checkbox" id="daytwo" name="daytwo" value="2">
                    <label for="daytwo">Den 2</label>
                </div>
                <div>
                    <input type="checkbox" id="daythree" name="daythree" value="3">
                    <label for="daythree">Den 3</label>
                </div>
                <div>
                    <input type="checkbox" id="dayfour" name="dayfour" value="4">
                    <label for="dayfour">Den 4</label>
                </div>
                <div>
                    <input type="checkbox" id="vip" name="vip" value="5">
